#!/usr/bin/python3
import binascii #convertir les octets en entier
import sys
import os.path

#SV est le tableau de constante , chaque élément i est obtenu en prenant 
#les 32 prmiers chiffres binaires de sin(i)
